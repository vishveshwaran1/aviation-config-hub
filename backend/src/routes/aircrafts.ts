    ...
    try {
        ...
        const aircraft = await prisma.aircraft.create({
            data: {
                ...
                msn,
                registration_number,
                manufacture_date: (typeof manufacture_date === 'string' && manufacture_date.trim() !== "") ? new Date(manufacture_date) : null,
                delivery_date: (typeof delivery_date === 'string' && delivery_date.trim() !== "") ? new Date(delivery_date) : null,
                initial_flight_hours: Number(flight_hours),
                initial_flight_cycles: Number(flight_cycles),
    ...
    try {
        ...
        const aircraft = await prisma.aircraft.update({
            ...
            data: {
                ...
                msn,
                registration_number,
                manufacture_date: (typeof manufacture_date === 'string' && manufacture_date.trim() !== "") ? new Date(manufacture_date) : undefined,
                delivery_date: (typeof delivery_date === 'string' && delivery_date.trim() !== "") ? new Date(delivery_date) : undefined,
                initial_flight_hours: flight_hours !== undefined ? Number(flight_hours) : undefined,
                initial_flight_cycles: flight_cycles !== undefined ? Number(flight_cycles) : undefined,
